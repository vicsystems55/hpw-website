...
<!-- Mirrored from t.commonsupport.com/care-giver/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Oct 2023 13:29:45 GMT -->
<head>
<meta charset="utf-8">
<title>CareGiver - Elder Care HTML Template | Home Page 03</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
    ...
    <header class="main-header header-style-three">
            ...
            <div class="auto-container clearfix">
                ...
                <div class="top-right clearfix">
					...
					<ul class="info-list">
						...
						<li><a href="/">Franchies Opportunity</a></li>
                    </ul>
					<!--Language-->
            ...
            <div class="inner-container">
                <div class="auto-container clearfix">
                    ...
                    <div class="logo-outer">
                        <div class="logo"><a href="index.html"><img src="site/images/logo-3.png" alt="" title=""></a></div>
                    </div>
                    ...
                    <div class="nav-outer clearfix">
                        ...
                        <div class="outer-box clearfix">
                            <!-- Button Box -->
                            <div class="btn-box">
                                <a href="/" class="theme-btn btn-style-one"><span class="txt">Ask a Question</span></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="sticky-header">
            <div class="auto-container clearfix">
                ...
                <div class="logo pull-left">
                    <a href="index.html" title=""><img src="site/images/logo-small.png" alt="" title=""></a>
                </div>
                <!--Right Col-->
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
            	<div class="nav-logo"><a href="index.html"><img src="site/images/nav-logo.png" alt="" title=""></a></div>
        ...
        <div class="rev_slider_wrapper fullwidthbanner-container"  id="rev_slider_two_wrapper" data-source="gallery">
            <div class="rev_slider fullwidthabanner" id="rev_slider_two" data-version="5.4.1">
                <ul>
                    ...
                    <img alt="" class="rev-slidebg" data-bgfit="cover" data-bgparallax="10" data-bgposition="center center" data-bgrepeat="no-repeat" data-no-retina="" src="site/images/main-slider/7.jpg">
				...
				<div class="row clearfix">
					...
					<div class="info-box col-lg-4 col-md-6 col-sm-12">
						<div class="box-inner">
							...
							<h4>Toll Free No.<a href="tel:1800-654-9871" class="phone">1800 654 9871</a></h4>
						</div>
					</div>
					...
					<div class="info-box col-lg-4 col-md-6 col-sm-12">
						<div class="box-inner">
							...
							<h4>send us mail<a href="mailto:contact@caregiver.com">contact@caregiver.com</a></h4>
						</div>
					</div>
					...
					<div class="info-box col-lg-4 col-md-6 col-sm-12">
						<div class="box-inner">
							...
							<h4>Our location<span>547, Lorance Street, NY</span></h4>
						</div>
					</div>
				...
				<div class="title-column col-lg-4 col-md-12 col-sm-12">
					<div class="inner-column">
						...
						<div class="sec-title-two light">
							<h2>Welcome to our <br> Care Giver</h2>
							<div class="text">From its medieval origins to the digital era, learn everything there is to know about the ubiquitous lorem ipsum passage. From its medieval origins to the digital era, learn everything .</div>
						</div>
					</div>
				</div>
							...
							<div class="service-block-five col-lg-6 col-md-6 col-sm-12">
								<div class="inner-box">
									<div class="content">
										...
										<h3><a href="nursing.html">Personal Grooming Like <br> Bathing or Getting <br> Dressed</a></h3>
									</div>
								</div>
							</div>
							...
							<div class="service-block-five col-lg-6 col-md-6 col-sm-12">
								<div class="inner-box">
									<div class="content">
										...
										<h3><a href="nursing.html">Moving Around. Getting <br> in and out of the Bed or Shower</a></h3>
									</div>
								</div>
							</div>
		...
		<div class="auto-container">
			...
			<div class="services-carousel owl-carousel owl-theme">
				...
				<div class="service-block-two">
					<div class="inner-box">
						<div class="image">
							<a href="elderly-service.html"><img src="site/images/resource/service-4.jpg" alt="" /></a>
						</div>
				...
				<div class="service-block-two">
					<div class="inner-box">
						<div class="image">
							<a href="support.html"><img src="site/images/resource/service-5.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
				...
				<div class="service-block-two">
					<div class="inner-box">
						<div class="image">
							<a href="respite-care.html"><img src="site/images/resource/service-6.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
				...
				<div class="service-block-two">
					<div class="inner-box">
						<div class="image">
							<a href="personal-care.html"><img src="site/images/resource/service-7.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
		...
		<div class="auto-container">
			...
			<div class="clearfix">
				...
				<div class="service-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<img src="site/images/resource/service-1.jpg" alt="" />
				...
				<div class="service-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<img src="site/images/resource/service-2.jpg" alt="" />
							<div class="overlay-box">
								<div class="overlay-inner">
									<div class="content">
										<div class="content-inner">
				...
				<div class="service-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<img src="site/images/resource/service-3.jpg" alt="" />
							<div class="overlay-box">
								<div class="overlay-inner">
									<div class="content">
										<div class="content-inner">
						...
						<div class="inner-column">
							<div class="row clearfix">
								...
								<div class="column col-lg-6 col-md-6 col-sm-12">
									<div class="image">
										<img src="site/images/resource/quality-1.jpg" alt="" />
									</div>
								</div>
								<div class="column col-lg-6 col-md-6 col-sm-12">
									<div class="image">
										<img src="site/images/resource/quality-2.jpg" alt="" />
									</div>
								</div>
				...
				<div class="testimonial-block">
					<div class="inner-box">
						...
						<div class="lower-box">
							<div class="box-inner">
								<div class="image">
									<img src="site/images/resource/author-1.jpg" alt="" />
								</div>
	...
	<section class="appointment-section">
		<div class="auto-container">
			...
			<div class="default-form style-two">
				<form method="post" action="https://t.commonsupport.com/care-giver//">
					<div class="row clearfix">
						...
						<div class="form-group col-lg-12 col-md-12 col-sm-12">
							<button type="submit" class="theme-btn btn-style-four"><span class="txt">Submit now</span></button>
						</div>
					</div>
				</form>
			</div>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="footer-column col-lg-7 col-md-6 col-sm-12">
                                <div class="footer-widget logo-widget">
									<div class="logo">
                                    	<a href="index.html"><img src="site/images/footer-logo.png" alt="" /></a>
                                    </div>
...
<script src="site/js/jquery.timepicker.min.js"></script>
<script src="site/js/script.js"></script>
</body>

<!-- Mirrored from t.commonsupport.com/care-giver/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Oct 2023 13:30:27 GMT -->
</html>
